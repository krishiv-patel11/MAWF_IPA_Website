...
export default function Hero() {
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden bg-[hsl(215_35%_18%)]">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] min-h-[100svh] px-6 lg:px-10 flex flex-col justify-center pt-32 pb-24">
        ...
        <div className="max-w-2xl">
          ...
          <motion.span
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-4 py-1.5 text-sm font-semibold uppercase tracking-[0.2em] text-white backdrop-blur"
          >
          ...
          <motion.h1
            ...
            className="mt-7 font-display text-5xl sm:text-6xl lg:text-[4.2rem] leading-[1.05] tracking-tight text-white"
          >
          ...
          <motion.p
            ...
            className="mt-6 max-w-lg text-xl leading-relaxed text-white/85"
          >
            Independent primary care physicians across West Florida, partnering with Medicare Advantage plans to deliver coordinated, personalized care.
          </motion.p>
