        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-5 mt-5">
            ...
            <div>
              ...
              <label className="block text-base font-medium text-[hsl(215_35%_24%)] mb-2">
                I am a…
              </label>
          ...
          <button
            type="submit"
            className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[hsl(205_78%_44%)] px-6 py-4 text-lg font-semibold text-white hover:bg-[hsl(205_78%_40%)] transition-colors"
          >
